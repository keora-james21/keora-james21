...
void choice_back_door() {
  cout << "You sneak around back and find a hidden door." << endl;
  cout << "The door is unlocked and you escape with a treasure!" << endl;
}

void choice_sneak_around_back() {
  cout << "You sneak around back and find a creepy old shed." << endl;
  cout << "Inside, you find a dusty old chest." << endl;
  cout << "Do you open the chest?" << endl;
  cout << "1. Yes" << endl;
  cout << "2. No, it's too scary" << endl;
  ...
  if (choice == 1) {
    cout << "You open the chest and find a treasure map!" << endl;
    cout << "You win!" << endl;
  } else if (choice == 2) {
    cout << "You walk away and go home safe." << endl;
  } else {
    cout << "Invalid choice, returning to main menu." << endl;
    main_menu();
  }
...
void choice_go_home() {
  cout << "You decide this adventure is too scary and go home safe." << endl;
}

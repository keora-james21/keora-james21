...
// of any size. It calculaes this data from user input, which
...
int main()
{
    ...
    // Variables
    double lenght, // The crate's length
    ...
    // Calculate the crate's volume, teh cost to produce it,
    // the chrage to the customer, and the profit
